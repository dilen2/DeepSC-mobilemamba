...
def get_ext():
    ...
    ext_modules.append(
        CUDAExtension(
            name="adaptive_selective_scan_cuda_core",
            sources=[
...
setup(
    ...
    version="0.0.2",
    packages=[],
    author="Tri Dao, Albert Gu, Mzreo, Tong Wu",
    author_email="tri@tridao.me, agu@cs.cmu.edu, liuyue171@mails.ucas.ac.cn, wu_tong@sjtu.edu.cn",
